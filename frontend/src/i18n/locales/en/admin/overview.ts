export default {
    ...
    users: {
      ...
      ipRisk: {
        action: 'IP Registration Risk',
        title: 'Duplicate Registration IP Risk',
        description: 'This list groups accounts sharing a registration IP and all blocked IPs. Blocking prevents future registrations from that IP without disabling existing accounts.',
        manualIp: 'IP Address',
        ipPlaceholder: 'For example, 203.0.113.10 or 2001:db8::1',
        prepareBlock: 'Block IP',
        blockingIp: 'Preparing to block {ip}',
        reasonPlaceholder: 'Reason (optional, up to 500 characters)',
        confirmBlock: 'Confirm Block',
        block: 'Block',
        unblock: 'Unblock',
        blocked: 'Blocked',
        unblocked: 'Allowed',
        openForIp: 'View and manage {ip}',
        unblockTitle: 'Unblock IP',
        unblockConfirm: 'Allow registrations from {ip} again?',
        empty: 'No duplicate registration IPs found',
        emptyHint: 'Blocked IPs also appear in this list.',
        loadFailed: 'Failed to load registration IP risks',
        blockSuccess: 'Blocked IP {ip}',
        blockFailed: 'Failed to block IP',
        unblockSuccess: 'Unblocked IP {ip}',
        unblockFailed: 'Failed to unblock IP',
        columns: {
          ip: 'IP Address',
          count: 'Accounts',
          users: 'Registered Accounts',
          firstRegistered: 'First Registration',
          lastRegistered: 'Latest Registration',
          status: 'Status',
          actions: 'Actions'
        }
      },
