export default {
    ...
    users: {
      ...
      ipRisk: {
        action: 'IP 注册风险',
        title: '重复注册 IP 风险',
        description: '这里汇总同一注册 IP 下的多个账号和已封禁 IP。封禁只会阻止该 IP 继续注册，不会停用已有账号。',
        manualIp: 'IP 地址',
        ipPlaceholder: '例如 203.0.113.10 或 2001:db8::1',
        prepareBlock: '封禁 IP',
        blockingIp: '准备封禁 {ip}',
        reasonPlaceholder: '封禁原因（可选，最多 500 字）',
        confirmBlock: '确认封禁',
        block: '封禁',
        unblock: '解除封禁',
        blocked: '已封禁',
        unblocked: '未封禁',
        openForIp: '查看并管理 {ip}',
        unblockTitle: '解除 IP 封禁',
        unblockConfirm: '确定允许 IP {ip} 再次注册吗？',
        empty: '暂未发现重复注册 IP',
        emptyHint: '已封禁 IP 也会显示在此列表中。',
        loadFailed: '加载 IP 注册风险失败',
        blockSuccess: '已封禁 IP {ip}',
        blockFailed: '封禁 IP 失败',
        unblockSuccess: '已解除 IP {ip} 的封禁',
        unblockFailed: '解除 IP 封禁失败',
        columns: {
          ip: 'IP 地址',
          count: '账号数',
          users: '注册账号',
          firstRegistered: '首次注册',
          lastRegistered: '最近注册',
          status: '状态',
          actions: '操作'
        }
