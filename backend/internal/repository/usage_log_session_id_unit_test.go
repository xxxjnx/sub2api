...
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 59, "arg-type table must include request detail columns")
	...
	// The trailing values are session_id, request_data, request_content_type, created_at.
